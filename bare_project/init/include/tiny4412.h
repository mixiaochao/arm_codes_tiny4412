...
#define CONFIG_SECURE_KERNEL_BASE	0x40008000  //内核被bootloader加载的地址
...
#define CONFIG_SYS_PROMPT		"[root@laomi]# "
...
#define CONFIG_PHY_UBOOT_BASE		CONFIG_SYS_SDRAM_BASE + 0x3e00000 //0x43e00000
